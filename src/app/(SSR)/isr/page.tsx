...
export const metadata = {
    title : "Incremental static regenerator - Next.Js 13.4"
}
...
export default async function Dynamic () {
    ...
    return(
        <div className="d-flex flex-column align-items-center">
            <Alert>
                This page <strong>Fetches the data dynamically but after a certain delay in here it is 10sec</strong> Everytime you refeshes the page you get a new image (after a given period of time) by upslash api :)
            </Alert>
